            ...
            <div className="space-y-6">
              ...
              <div>
                <p className="text-[#232326] text-base sm:text-lg">
                  ...
                  <a
                    ...
                    className="text-[#232326] hover:text-[#E62614] transition-colors"
                  >
              ...
              <div className="flex items-center gap-4 pt-4">
                <a
                  ...
                  className="flex items-center justify-center w-12 h-12 rounded-full bg-[#E62614] hover:bg-[#E62614]/90 transition-colors"
                  aria-label="Telegram"
                >
