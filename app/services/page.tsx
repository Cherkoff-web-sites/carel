      ...
      <section className="py-8 sm:py-12 lg:py-16">
        <div className="container">
          <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold mb-8 sm:mb-12">
            <span className="bg-gradient-to-r from-[#E62614] to-[#E62614] bg-clip-text text-transparent">
              УСЛУГИ
            </span>
          </h1>
            ...
            {services.map((service) => (
              <div
                ...
                style={{
                  ...
                  backgroundImage: 'linear-gradient(#2A2529, #2A2529), linear-gradient(to right, #E62614, #E62614)',
