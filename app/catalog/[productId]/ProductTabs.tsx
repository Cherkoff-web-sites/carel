        ...
        <button
          ...
          className={`px-6 py-4 text-sm font-medium transition-colors whitespace-nowrap ${
            activeTab === 'description'
              ? 'text-[#E62614] border-b-2 border-[#E62614]'
                    ...
                    <table className="w-full border-collapse">
                      <thead>
                        <tr className="bg-[#3B363C]">
                          <th className="border border-[#E62614] px-4 py-3 text-left text-sm font-semibold">Модель</th>
                          <th className="border border-[#E62614] px-4 py-3 text-left text-sm font-semibold">Входной ток (A)</th>
                          <th className="border border-[#E62614] px-4 py-3 text-left text-sm font-semibold">Выходной ток (A)</th>
                          <th className="border border-[#E62614] px-4 py-3 text-left text-sm font-semibold">Мощность электродвигателя (кВт)</th>
                        </tr>
                      </thead>
                      <tbody>
                        <tr className="bg-[#2A2529] hover:bg-[#3B363C] transition-colors">
                          <td className="border border-[#E62614] px-4 py-3">ENT-100-2S-0.4G</td>
                          <td className="border border-[#E62614] px-4 py-3">5.4</td>
                          <td className="border border-[#E62614] px-4 py-3">2.3</td>
                          <td className="border border-[#E62614] px-4 py-3">0.4</td>
                        </tr>
                        <tr className="bg-[#2A2529] hover:bg-[#3B363C] transition-colors">
                          <td className="border border-[#E62614] px-4 py-3">ENT-100-2S-0.75G</td>
                          <td className="border border-[#E62614] px-4 py-3">8.2</td>
                          <td className="border border-[#E62614] px-4 py-3">4.0</td>
                          <td className="border border-[#E62614] px-4 py-3">0.75</td>
                        </tr>
                        <tr className="bg-[#2A2529] hover:bg-[#3B363C] transition-colors">
                          <td className="border border-[#E62614] px-4 py-3">ENT-100-2S-1.5G</td>
                          <td className="border border-[#E62614] px-4 py-3">14.0</td>
                          <td className="border border-[#E62614] px-4 py-3">7.0</td>
                          <td className="border border-[#E62614] px-4 py-3">1.5</td>
                        </tr>
                        <tr className="bg-[#2A2529] hover:bg-[#3B363C] transition-colors">
                          <td className="border border-[#E62614] px-4 py-3">ENT-100-2S-2.2G</td>
                          <td className="border border-[#E62614] px-4 py-3">23.0</td>
                          <td className="border border-[#E62614] px-4 py-3">9.6</td>
                          <td className="border border-[#E62614] px-4 py-3">2.2</td>
                        </tr>
                      </tbody>
                    </table>
                  </div>
                ...
                <div>
                  ...
                  <div className="overflow-x-auto">
                    <table className="w-full border-collapse">
                      ...
                      <tbody>
                        <tr className="bg-[#2A2529] hover:bg-[#3B363C] transition-colors">
                          <td className="border border-[#E62614] px-4 py-3">ENT-100-2T-0.4G</td>
                          <td className="border border-[#E62614] px-4 py-3">2.7</td>
                          <td className="border border-[#E62614] px-4 py-3">2.3</td>
                          <td className="border border-[#E62614] px-4 py-3">0.4</td>
                        </tr>
                        <tr className="bg-[#2A2529] hover:bg-[#3B363C] transition-colors">
                          <td className="border border-[#E62614] px-4 py-3">ENT-100-2T-0.7G</td>
                          <td className="border border-[#E62614] px-4 py-3">4.2</td>
                          <td className="border border-[#E62614] px-4 py-3">4.0</td>
                          <td className="border border-[#E62614] px-4 py-3">0.75</td>
                        </tr>
                        <tr className="bg-[#2A2529] hover:bg-[#3B363C] transition-colors">
                          <td className="border border-[#E62614] px-4 py-3">ENT-100-2T-1.5G</td>
                          <td className="border border-[#E62614] px-4 py-3">7.7</td>
                          <td className="border border-[#E62614] px-4 py-3">7.0</td>
                          <td className="border border-[#E62614] px-4 py-3">1.5</td>
                        </tr>
                        <tr className="bg-[#2A2529] hover:bg-[#3B363C] transition-colors">
                          <td className="border border-[#E62614] px-4 py-3">ENT-100-2T-2.2G</td>
                          <td className="border border-[#E62614] px-4 py-3">12</td>
                          <td className="border border-[#E62614] px-4 py-3">9.6</td>
                          <td className="border border-[#E62614] px-4 py-3">2.2</td>
                        </tr>
                      </tbody>
                ...
                <div>
                  ...
                  <div className="overflow-x-auto">
                    <table className="w-full border-collapse">
                      ...
                      <tbody>
                        <tr className="bg-[#2A2529] hover:bg-[#3B363C] transition-colors">
                          <td className="border border-[#E62614] px-4 py-3">ENT-100-4T-0.75G/1.5P</td>
                          <td className="border border-[#E62614] px-4 py-3">3.4</td>
                          <td className="border border-[#E62614] px-4 py-3">2.1</td>
                          <td className="border border-[#E62614] px-4 py-3">0.75</td>
                        </tr>
                        <tr className="bg-[#2A2529] hover:bg-[#3B363C] transition-colors">
                          <td className="border border-[#E62614] px-4 py-3">ENT-100-4T-1.5G/2.2P</td>
                          <td className="border border-[#E62614] px-4 py-3">5.0/5.8</td>
                          <td className="border border-[#E62614] px-4 py-3">3.8/5.1</td>
                          <td className="border border-[#E62614] px-4 py-3">1.5/2.2</td>
                        </tr>
                        <tr className="bg-[#2A2529] hover:bg-[#3B363C] transition-colors">
                          <td className="border border-[#E62614] px-4 py-3">ENT-100-4T-2.2G/3.7P</td>
                          <td className="border border-[#E62614] px-4 py-3">5.8/10.5</td>
                          <td className="border border-[#E62614] px-4 py-3">5.1/9.0</td>
                          <td className="border border-[#E62614] px-4 py-3">2.2/4.0</td>
                        </tr>
                        <tr className="bg-[#2A2529] hover:bg-[#3B363C] transition-colors">
                          <td className="border border-[#E62614] px-4 py-3">ENT-100-4T-4.0G/4.0P</td>
                          <td className="border border-[#E62614] px-4 py-3">10.5/14.6</td>
                          <td className="border border-[#E62614] px-4 py-3">9.0/13.0</td>
                          <td className="border border-[#E62614] px-4 py-3">4.0/5.5</td>
                        </tr>
                        <tr className="bg-[#2A2529] hover:bg-[#3B363C] transition-colors">
                          <td className="border border-[#E62614] px-4 py-3">ENT-100-4T-5.5G/7.5P</td>
                          <td className="border border-[#E62614] px-4 py-3">14.6/20.5</td>
                          <td className="border border-[#E62614] px-4 py-3">13.0/17.0</td>
                          <td className="border border-[#E62614] px-4 py-3">5.5/7.5</td>
                        </tr>
                      </tbody>
                    </table>
                  </div>
                    ...
                    <thead>
                      <tr className="bg-[#3B363C]">
                        {table.headers.map((header, index) => (
                          <th key={index} className="border border-[#E62614] px-4 py-3 text-left text-sm font-semibold">
                            {header}
                          </th>
                        ))}
                      </tr>
                      ...
                      {table.rows.map((row, rowIndex) => (
                        <tr key={rowIndex} className="bg-[#2A2529] hover:bg-[#3B363C] transition-colors">
                          {row.map((cell, cellIndex) => (
                            <td key={cellIndex} className="border border-[#E62614] px-4 py-3">
                              {cell}
                            </td>
                          ))}
                        </tr>
        ...
        {activeTab === 'delivery' && (
          <div className="text-white/90 space-y-8">
            ...
            <div>
              {product.id === 'motor' ? (
                <>
                  <div className="w-16 h-1 bg-[#E62614] mb-4"></div>
            ...
            {/* Гарантия */}
            <div>
              {product.id !== 'motor' && <div className="w-16 h-1 bg-[#E62614] mb-4"></div>}
              <h3 className="text-white font-semibold mb-4 text-xl sm:text-2xl">
                Гарантия
              </h3>
              <p className="text-white/90 text-sm sm:text-base leading-relaxed">
