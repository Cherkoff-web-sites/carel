              ...
              {content.about?.paragraphs.map((paragraph, index) => (
                <div key={index} className="mb-4">
                  ...
                  <textarea
                    ...
                    className="w-full px-4 py-2 bg-[#3B363C] border border-[#E62614] rounded-lg text-white resize-none"
                    rows={4}
                  />
                </div>
              ))}
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-2 bg-[#3B363C] border border-[#E62614] rounded-lg text-white"
                  />
                </div>
                <div>
  ...
  return (
    <div className="bg-[#2A2529] rounded-lg p-6">
      <div className="flex justify-between items-start mb-4">
        <div>
          <h3 className="text-xl font-semibold text-[#E62614] mb-1">{product.name}</h3>
          <p className="text-white/70 text-sm">{product.series} • {product.category}</p>
        </div>
        <button
          onClick={() => setIsExpanded(!isExpanded)}
          className="text-[#E62614] hover:text-[#E62614]/80 text-sm"
        >
          ...
          <>
            ...
            <div className="md:col-span-2">
              ...
              <textarea
                ...
                className="w-full px-4 py-2 bg-[#3B363C] border border-[#E62614] rounded-lg text-white font-mono text-sm resize-none"
                rows={3}
              />
            </div>
          </>
