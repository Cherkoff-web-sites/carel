...
export default function CatalogBuyButton({ onClick, className = '' }: CatalogBuyButtonProps) {
  return (
    <button
      type="button"
      onClick={onClick}
      className={`inline-flex shrink-0 items-center justify-center gap-2.5 bg-transparent px-2 py-2 text-base font-medium text-[#232326] transition-colors hover:text-[#232326]/70 ${className}`}
    >
      <CartIcon />
      Купить
    </button>
