...
type ProductDetailCartIconButtonProps = {
  getCartItem: () => Omit<CartItem, 'quantity'>
  ariaLabel: string
}
...
export default function ProductDetailCartIconButton({
  getCartItem,
  ariaLabel,
}: ProductDetailCartIconButtonProps) {
  ...
  return (
    <button
      type="button"
      onClick={handleClick}
      className="inline-flex h-[52px] w-[52px] shrink-0 items-center justify-center rounded-[5px] border border-[#232326]/20 bg-white text-[#232326]/75 transition-colors hover:border-[#E62614]/40 hover:text-[#E62614]"
